...
def test_load_rejects_malicious_pickle(tmp_path: Path, loop) -> None:
...
def test_load_rejects_eval_payload(tmp_path: Path, loop) -> None:
...
def test_load_rejects_subprocess_payload(tmp_path: Path, loop) -> None:
...
def test_load_does_not_execute_payload_side_effect(tmp_path: Path, loop) -> None:
...
def test_load_rejects_protocol_0_global_payload(tmp_path: Path, loop) -> None:
